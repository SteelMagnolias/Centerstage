...
@Autonomous(name = "OdoBlue", group="Iterative OpMode")
public class OdoBlue extends LinearOpMode {
    ...
    int spikeMark = 1;
    private static int desiredTagID = 2;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        intakeClawRight = hardwareMap.get(CRServo.class, "intakeClawLeft"); // swapped because opposite ones need to open from odoRed
        intakeClawLeft = hardwareMap.get(CRServo.class, "intakeClawRight");
        intakeClawRight.setDirection(CRServo.Direction.REVERSE);
        ...
        while(!isStopRequested()){
            ...
            switch(step) {
                ...
                case 3: // rotate until forward to avoid stacks
                    rotate(-0.1);
                    if (pose[2] >= Math.toRadians(-100) && (spikeMark == 1 || spikeMark == 2)) {
                        rotate(0);
                        step++;
                    } else if (pose[2] >= Math.toRadians(-110) && spikeMark == 3){
                        rotate(0);
                        step++;
                    }
                    break;
                ...
                case 7: // strafe to not hit pixel stacks
                    strafe(-0.3);
                    if (pose[0] <= -20 && (spikeMark == 1 || spikeMark == 2)) {
                        drive(0);
                        step++;
                    } else if (pose[0] <= 0 && spikeMark == 3){
                        drive(0);
                        step++;
                    }
                ...
                case 8: // turn to go through truss
                    rotate(0.65);
                    if(spikeMark == 3 && pose[2] <= Math.toRadians(5)){
                        rotate(0);
                        step++;
                    }else if (pose[2] <= Math.toRadians(20) && (spikeMark == 2 || spikeMark == 1)) {
                        rotate(0);
                        step++;
                    }
                    break;
                case 9: // through stage door
                    drive(-0.95);
                    if (pose[0] <= -190 && (spikeMark == 1 || spikeMark ==2)) {
                        drive(0);
                        step++;
                    } else if (pose[0] <= -170 && spikeMark == 3){
                        drive(0);
                        step++;
                    }
                    break;
        ...
        switch (stackedStep) {
            ...
            case 6:
                ...
                if (pose[2] >= Math.toRadians(450)) {
                    rotate(0);
                    step++;
                    pose[2] -= (2 * Math.PI); // just to get in the right frame of reference
                }
                break;
        }
    }
