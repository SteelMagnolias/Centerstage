...
@Autonomous(name = "OdoTuningTest2", group="Iterative OpMode")
public class OdoTuningTest2 extends OpMode {
    ...
    public void loop() {
        ...
        if (numCases > 10) {
            switch (step) {
                case 0: // strafe left 10 cm from origin
                    strafe(-0.3);
                    if (pose[0] >= 10) {
                        strafe(0);
                        step++;
                    ...
                    break;
                case 1: // strafe right 10 cm back to origin
                    strafe(0.3);
                    if (pose[0] <= 0) {
                        strafe(0);
                        step--;
        ...
        if (numCases > 10) {
            switch (step) {
                case 0: // turn counter clockwise 90 degrees
                    rotate(-0.3);
